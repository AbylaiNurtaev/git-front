              ...
              <div className="tab-header">
                ...
                <div className="roulette-info">
                  <p className="info-text">
                    ...
                    Каждый слот имеет приз и вероятность выпадения. Максимум 35 слотов.
                  </p>
                  <p className="info-text">
                    <strong>Как это работает:</strong> Создайте приз в разделе "Призы", 
                    указав индекс слота (0-34). Приз автоматически появится в рулетке.
                  </p>
                </div>
              </div>
              <div className="roulette-config">
                ...
                <div className="roulette-actions">
                  ...
                  <p className="hint-text">
                    При создании приза укажите индекс слота (0-34), и он появится в рулетке
                  </p>
                </div>
              </div>
            </div>
